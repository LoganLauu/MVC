...
<div class='container'>
<form onsubmit="return checkRegisterForm();" action="RegisterUserServlet" method="post">

<label><center>Enter your UserID:</label> 
<div class="space"></div>
<input type="text" id="username" name="username" ></center></label><br>

<label><center>Enter your Password:</label> 
<div class="spaceA"></div>
<input type="password" id="password" name="password" ></center></label><br>

<label><center>Confirm your Password:</label> 
<input type="password" id="c_password" name="c_password" ></center></label><br><br>
