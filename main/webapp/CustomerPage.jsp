...
<body>
<div class='header'>
<h1><center><a href="CustomerPage.jsp">Customer Portal</a></center></h1>
</div>

<div class ='topnav'>
	<form onsubmit='return checkForm();' action='SearchBookServlet' target="iframe_a">
...
<div class="sidenav">
	...
	<a href="ViewBookServlet" target=iframe_a style="padding-top:10px;">View Books</a><hr>
	<a href="OrderByIDServlet" target=iframe_a >Purchase Books</a><hr>
	<a href="TransactionHistoryServlet" target=iframe_a >Transaction History</a><hr>
	<button class="dropdown-btn">Book Categories 	
    <i class="fa fa-caret-down"></i>
  	</button>
  	<div class="dropdown-container">
    <a href="ViewRomanceServlet" target="iframe_a">Romance</a>
    <a href="ViewHorrorServlet" target="iframe_a">Horror</a>
    <a href="ViewFictionServlet" target="iframe_a">Fiction</a>
    <a href="ViewFantasyServlet" target="iframe_a">Fantasy</a>
    <a href="ViewPoetryServlet" target="iframe_a">Poetry</a>
  	</div><hr>
	<a href="LogoutServlet" style="padding-bottom:10px;">Log out</a>
</div>

<div class="iframe_a" >
<iframe src="CustomerPageBG.jsp" name="iframe_a" height="780px" width="1000px" title="iframe" frameBorder="0"></iframe>
</div>
